...
namespace IndianArmyWeb.Areas.cpanel.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult ChangePassword()
        {
            ...
            ViewBag.arGs = csConst.cSalt.ToString();
            return View();
        }
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            //model.NewPassword = AESEncrytDecry.DecryptStringAES(model.NewPassword); //AESEncrytDecry.DecryptStringAES(model.ConfirmPassword).Replace(csConst.cSalt, "")
            //ModelState.Remove("NewPassword");
            if (!ModelState.IsValid)
            {
                return View(model);
            }
            if ( model.NewPassword.Length < 128)
            {
                this.AddNotification("Password Must be contain at least 8 characters, least 1 number and both lower and uppercase letters and special characters", NotificationType.WARNING);
                return View(model);
            }
            ...
            //AddErrors(result);
            this.AddNotification(result.Errors.ToString(), NotificationType.WARNING);
            //return View(model);
